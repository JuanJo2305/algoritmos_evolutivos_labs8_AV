...
# === Guardar fitness_real.csv ===
df_fitness = pd.DataFrame({
    'Generacion': list(range(len(historial_fitness))),
    'Fitness': historial_fitness
})
df_fitness.to_csv('fitness_real.csv', index=False)
print("Archivo 'fitness_real.csv' guardado.")


# === Guardar asignaciones_real.csv ===
filas = []
for examen in ['A', 'B', 'C']:
...
df_asignaciones.to_csv('asignaciones_real.csv', index=False)
print("Archivo 'asignaciones_real.csv' guardado.")
