...
# === Guardar fitness_permutacional.csv ===
df_fitness = pd.DataFrame({
    'Generacion': list(range(len(historial))),
    'Fitness': historial
})
df_fitness.to_csv('fitness_permutacional.csv', index=False)
print("Archivo 'fitness_permutacional.csv' guardado.")


# === Guardar asignaciones_permutacional.csv ===
filas = []
for examen in ['A', 'B', 'C']:
...
df_asignaciones.to_csv('asignaciones_permutacional.csv', index=False)
print("Archivo 'asignaciones_permutacional.csv' guardado.")
